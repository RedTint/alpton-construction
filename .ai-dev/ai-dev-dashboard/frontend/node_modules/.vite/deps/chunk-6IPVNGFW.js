import {
  ...
  uniq_default,
  values_default
} from "./chunk-XBJJYQRV.js";
import {
  isEmpty_default
} from "./chunk-HNM22KFX.js";
import {
  identity_default,
  isArray_default,
  isFunction_default,
  isObject_default
} from "./chunk-ZYKDGHOZ.js";
import {
  __commonJS,
  __esm,
  __export,
...
var require_linkedMap = __commonJS({
  "node_modules/vscode-jsonrpc/lib/common/linkedMap.js"(exports) {
    ...
    var LinkedMap = class {
      ...
      get first() {
        var _a7;
        return (_a7 = this._head) == null ? void 0 : _a7.value;
      }
      get last() {
        var _a7;
        return (_a7 = this._tail) == null ? void 0 : _a7.value;
      }
      has(key) {
      ...
      [(_a6 = Symbol.toStringTag, Symbol.iterator)]() {
        return this.entries();
      }
      trimOld(newSize) {
...
var require_api2 = __commonJS({
  "node_modules/vscode-languageserver-protocol/lib/common/api.js"(exports) {
    ...
    })(LSPErrorCodes2 || (exports.LSPErrorCodes = LSPErrorCodes2 = {}));
  }
});
...
var AbstractAstReflection = class {
  ...
  getReferenceType(refInfo) {
    ...
    const referenceType = (_a6 = metaData.properties[refInfo.property]) == null ? void 0 : _a6.referenceType;
    if (!referenceType) {
...
function streamAst(root, options) {
  if (!root) {
    throw new Error("Root node must be an AstNode.");
  } else if ((options == null ? void 0 : options.range) && !isAstNodeInRange(root, options.range)) {
...
function isAstNodeInRange(astNode, range) {
  ...
  const nodeRange = (_a6 = astNode.$cstNode) == null ? void 0 : _a6.range;
  if (!nodeRange) {
    return false;
  }
...
function findNodesForKeyword(node, keyword) {
  ...
  return findNodesForKeywordInternal(node, keyword, node == null ? void 0 : node.astNode);
}
...
function findAssignment(cstNode) {
  ...
  while (astNode === ((_a6 = cstNode.container) == null ? void 0 : _a6.astNode)) {
...
function findNameAssignmentInternal(type, startNode, cache) {
  ...
  for (const node of streamAllContents(startNode)) {
    ...
    } else if (isSimpleType(node) && ((_a6 = node.typeRef) == null ? void 0 : _a6.ref)) {
...
function getActionType(action) {
  ...
  } else if ((_a6 = action.type) == null ? void 0 : _a6.ref) {
...
function getRuleTypeName(rule) {
  var _a6;
  if (isTerminalRule(rule)) {
    return ((_a6 = rule.type) == null ? void 0 : _a6.name) ?? "string";
  } else {
...
function abstractElementToRegex(element, flags) {
  ...
  if (isTerminalAlternatives(element)) {
    ...
    throw new Error(`Invalid terminal element: ${element == null ? void 0 : element.$type}, ${(_a6 = element == null ? void 0 : element.$cstNode) == null ? void 0 : _a6.text}`);
  }
}
...
var AbstractCstNode = class {
  ...
  get astNode() {
    var _a6, _b;
    const node = typeof ((_a6 = this._astNode) == null ? void 0 : _a6.$type) === "string" ? this._astNode : (_b = this.container) == null ? void 0 : _b.astNode;
    if (!node) {
...
var CompositeCstNodeImpl = class extends AbstractCstNode {
  ...
  get offset() {
    var _a6;
    return ((_a6 = this.firstNonHiddenNode) == null ? void 0 : _a6.offset) ?? 0;
  }
  get length() {
  ...
  get end() {
    var _a6;
    return ((_a6 = this.lastNonHiddenNode) == null ? void 0 : _a6.end) ?? 0;
  }
  get range() {
...
var AbstractLangiumParser = class {
  constructor(services) {
    ...
    if ((_a6 = services.shared.profilers.LangiumProfiler) == null ? void 0 : _a6.isActive("parsing")) {
...
function buildRuleCallPredicate(rule, namedArgs) {
  ...
  if (hasNamedArguments) {
    const namedPredicates = namedArgs.map((arg) => {
      var _a6, _b;
      return {
        parameterName: (_b = (_a6 = arg.parameter) == null ? void 0 : _a6.ref) == null ? void 0 : _b.name,
...
var DefaultValueConverter = class {
  ...
  runConverter(rule, input, cstNode) {
    ...
    switch ((_a6 = getRuleType(rule)) == null ? void 0 : _a6.toLowerCase()) {
      case "number":
...
var UriTrie = class {
  ...
  has(uri) {
    var _a6;
    return ((_a6 = this.getNode(this.normalizeUri(uri), false)) == null ? void 0 : _a6.element) !== void 0;
  }
  hasNode(uri) {
  ...
  find(uri) {
    var _a6;
    return (_a6 = this.getNode(this.normalizeUri(uri), false)) == null ? void 0 : _a6.element;
  }
  findNode(uri) {
...
var DefaultLangiumDocumentFactory = class {
  ...
  async update(document, cancellationToken) {
    var _a6, _b;
    const oldText = (_a6 = document.parseResult.value.$cstNode) == null ? void 0 : _a6.root.fullText;
    const textDocument = (_b = this.textDocuments) == null ? void 0 : _b.get(document.uri.toString());
...
var DefaultLinker = class {
  ...
  async link(document, cancelToken = cancellation_exports.CancellationToken.None) {
    var _a6;
    if ((_a6 = this.profiler) == null ? void 0 : _a6.isActive("linking")) {
  ...
  replacer(key, value, { refText, sourceText, textRegions, comments, uriConverter }) {
    ...
    if (this.ignoreProperties.has(key)) {
      ...
      if (refValue) {
        ...
        return {
          $error: ((_a6 = value.error) == null ? void 0 : _a6.message) ?? "Could not resolve reference",
          $refText
        };
      }
      ...
      if (textRegions) {
        ...
        if ((!key || value.$document) && (astNode == null ? void 0 : astNode.$textRegion)) {
          astNode.$textRegion.documentURI = (_b = this.currentDocument) == null ? void 0 : _b.uri.toString();
        }
      }
      if (sourceText && !key) {
        astNode ?? (astNode = { ...value });
        astNode.$sourceText = (_c = value.$cstNode) == null ? void 0 : _c.text;
      }
      if (comments) {
        astNode ?? (astNode = { ...value });
...
var DefaultServiceRegistry = class {
  ...
  getServices(uri) {
    ...
    const languageId = (_b = (_a6 = this.textDocuments) == null ? void 0 : _a6.get(uri)) == null ? void 0 : _b.languageId;
...
var DefaultDocumentValidator = class {
  ...
  async validateDocument(document, options = {}, cancelToken = cancellation_exports.CancellationToken.None) {
    ...
    if (!options.categories || options.categories.includes("built-in")) {
      ...
      if (options.stopAfterLexingErrors && diagnostics.some((d) => {
        var _a6;
        return ((_a6 = d.data) == null ? void 0 : _a6.code) === DocumentValidator.LexingError;
      })) {
        return diagnostics;
      }
      ...
      if (options.stopAfterParsingErrors && diagnostics.some((d) => {
        var _a6;
        return ((_a6 = d.data) == null ? void 0 : _a6.code) === DocumentValidator.ParsingError;
      })) {
        return diagnostics;
      }
      ...
      if (options.stopAfterLinkingErrors && diagnostics.some((d) => {
        var _a6;
        return ((_a6 = d.data) == null ? void 0 : _a6.code) === DocumentValidator.LinkingError;
      })) {
        return diagnostics;
      }
    }
  ...
  processLexingErrors(parseResult, diagnostics, _options) {
    var _a6;
    const lexerDiagnostics = [...parseResult.lexerErrors, ...((_a6 = parseResult.lexerReport) == null ? void 0 : _a6.diagnostics) ?? []];
    ...
    for (const reference of document.references) {
      ...
      if (linkingError) {
        const info = {
          ...
          range: (_a6 = reference.$refNode) == null ? void 0 : _a6.range,
  ...
  async validateAstNodes(rootNode, options, acceptor, cancelToken = cancellation_exports.CancellationToken.None) {
    var _a6;
    if ((_a6 = this.profiler) == null ? void 0 : _a6.isActive("validating")) {
...
var DefaultConfigurationProvider = class {
  ...
  initialize(params) {
    var _a6;
    this.workspaceConfig = ((_a6 = params.capabilities.workspace) == null ? void 0 : _a6.configuration) ?? false;
  }
...
var DefaultDocumentBuilder = class {
        ...
        if (typeof options.validation === "boolean" && options.validation) {
          ...
          if (categories.length > 0) {
            this.buildState.set(key, {
              ...
              result: (_a6 = this.buildState.get(key)) == null ? void 0 : _a6.result
            });
  ...
  async update(changed, deleted, cancelToken = cancellation_exports.CancellationToken.None) {
    ...
    const rebuildDocuments = this.sortDocuments(this.langiumDocuments.all.filter((doc) => {
      ...
      return (
        ...
        doc.state < DocumentState.Validated || !((_a6 = this.buildState.get(doc.uri.toString())) == null ? void 0 : _a6.completed) || this.resultsAreIncomplete(doc, this.updateBuildOptions)
      );
    }).toArray());
  ...
  findMissingValidationCategories(document, options) {
    ...
    const executedCategories = ((_a6 = state == null ? void 0 : state.result) == null ? void 0 : _a6.validationChecks) ? new Set((_b = state == null ? void 0 : state.result) == null ? void 0 : _b.validationChecks) : (state == null ? void 0 : state.completed) ? allCategories : /* @__PURE__ */ new Set();
  ...
  async findChangedUris(changed) {
    var _a6;
    const document = this.langiumDocuments.getDocument(changed) ?? ((_a6 = this.textDocuments) == null ? void 0 : _a6.get(changed));
    if (document) {
      return [changed];
    }
    try {
  ...
  hasTextDocument(doc) {
    var _a6;
    return Boolean((_a6 = this.textDocuments) == null ? void 0 : _a6.get(doc.uri));
  }
  /**
  ...
  getBuildOptions(document) {
    var _a6;
    return ((_a6 = this.buildState.get(document.uri.toString())) == null ? void 0 : _a6.options) ?? {};
  }
};
...
var DefaultLexer = class {
  ...
  tokenize(text, _options = DEFAULT_TOKENIZE_OPTIONS) {
    ...
    return {
      ...
      report: (_b = (_a6 = this.tokenBuilder).flushLexingReport) == null ? void 0 : _b.call(_a6, text)
    };
  }
...
function tokenize(context) {
  ...
  for (let i = 0; i < context.lines.length; i++) {
    ...
    if (first2 && context.options.start) {
      const match = (_a6 = context.options.start) == null ? void 0 : _a6.exec(line);
      if (match) {
        index = match.index + match[0].length;
      }
    } else {
      const match = (_b = context.options.line) == null ? void 0 : _b.exec(line);
      if (match) {
        index = match.index + match[0].length;
      }
    }
    if (last) {
      const match = (_c = context.options.end) == null ? void 0 : _c.exec(line);
      if (match) {
...
function parseJSDocComment(context) {
  ...
  const start = ((_a6 = elements[0]) == null ? void 0 : _a6.range.start) ?? startPosition;
  const end = ((_b = elements[elements.length - 1]) == null ? void 0 : _b.range.end) ?? startPosition;
...
${content}`;
  ...
  toMarkdown(options) {
    var _a6;
    return ((_a6 = options == null ? void 0 : options.renderTag) == null ? void 0 : _a6.call(options, this)) ?? this.toMarkdownDefault(options);
  }
...
function renderInlineTag(tag, content, options) {
  ...
  if (tag === "linkplain" || tag === "linkcode" || tag === "link") {
    ...
    const renderedLink = ((_a6 = options.renderLink) == null ? void 0 : _a6.call(options, content, display)) ?? renderLinkDefault(content, display);
    return renderedLink;
  }
  return void 0;
}
...
var DefaultCommentProvider = class {
  ...
  getComment(node) {
    ...
    return (_a6 = findCommentNode(node.$cstNode, this.grammarConfig().multilineCommentRules)) == null ? void 0 : _a6.text;
  }
};
...
var IndentationAwareTokenBuilder = class extends DefaultTokenBuilder {
  ...
  matchWhitespace(text, offset, tokens, groups) {
    ...
    return {
      currIndentLevel: (match == null ? void 0 : match[0].length) ?? 0,
  ...
  dedentMatcher(text, offset, tokens, groups) {
    ...
    if (matchIndentIndex === -1) {
      this.diagnostics.push({
        ...
        offset,
        length: ((_a6 = match == null ? void 0 : match[0]) == null ? void 0 : _a6.length) ?? 0,
    ...
    const newlinesBeforeDedent = ((_b = text.substring(0, offset).match(/[\r\n]+$/)) == null ? void 0 : _b[0].length) ?? 1;
...
var IndentationAwareLexer = class extends DefaultLexer {
  ...
  tokenize(text, options = DEFAULT_TOKENIZE_OPTIONS) {
    ...
    if ((options == null ? void 0 : options.mode) === "full") {
...
var DefaultLangiumProfiler = class {
  ...
  dumpRecord(category, record) {
    ...
    for (const key of record.entries.keys()) {
      ...
      result.push({ name: `${record.identifier}.${key}`, count: values.length, duration });
    }
...
// node_modules/@mermaid-js/parser/dist/chunks/mermaid-parser.core/chunk-XZSTWKYB.mjs
...
var ArchitectureGrammarGeneratedModule = {
  Grammar: __name(() => ArchitectureGrammarGrammar(), "Grammar"),
  LanguageMetaData: __name(() => ArchitectureGrammarLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var GitGraphGrammarGeneratedModule = {
  Grammar: __name(() => GitGraphGrammarGrammar(), "Grammar"),
  LanguageMetaData: __name(() => GitGraphGrammarLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var InfoGrammarGeneratedModule = {
  Grammar: __name(() => InfoGrammarGrammar(), "Grammar"),
  LanguageMetaData: __name(() => InfoGrammarLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var PacketGrammarGeneratedModule = {
  Grammar: __name(() => PacketGrammarGrammar(), "Grammar"),
  LanguageMetaData: __name(() => PacketGrammarLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var PieGrammarGeneratedModule = {
  Grammar: __name(() => PieGrammarGrammar(), "Grammar"),
  LanguageMetaData: __name(() => PieGrammarLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var RadarGrammarGeneratedModule = {
  Grammar: __name(() => RadarGrammarGrammar(), "Grammar"),
  LanguageMetaData: __name(() => RadarGrammarLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
var TreemapGrammarGeneratedModule = {
  Grammar: __name(() => TreemapGrammarGrammar(), "Grammar"),
  LanguageMetaData: __name(() => TreemapGrammarLanguageMetaData, "LanguageMetaData"),
  parser: {}
};
...
//# sourceMappingURL=chunk-6IPVNGFW.js.map
