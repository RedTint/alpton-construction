...
var require_cose_base = __commonJS({
  "node_modules/cytoscape-fcose/node_modules/cose-base/cose-base.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module === "object")
...
// node_modules/mermaid/dist/chunks/mermaid.core/architectureDiagram-2XIMDMQ5.mjs
...
var ArchitectureDB = (_a = class {
  ...
  addGroup({ id, icon, in: parent, title }) {
    var _a2, _b, _c;
    if (((_a2 = this.registeredIds) == null ? void 0 : _a2[id]) !== void 0) {
      throw new Error(
    ...
    if (parent !== void 0) {
      ...
      if (((_b = this.registeredIds) == null ? void 0 : _b[parent]) === void 0) {
        throw new Error(
          `The group [${id}]'s parent does not exist. Please make sure the parent is created before this group`
        );
      }
      if (((_c = this.registeredIds) == null ? void 0 : _c[parent]) === "node") {
...
var drawEdges = __name(async function(edgesEl, cy, db) {
...
var drawGroups = __name(async function(groupsEl, cy, db) {
  const padding = db.getConfigField("padding");
...
var drawServices = __name(async function(db, elem, services) {
...
var drawJunctions = __name(function(db, elem, junctions) {
...
function getAlignments(db, spatialMaps, groupAlignments) {
  const flattenAlignments = __name((alignmentObj, alignmentDir) => {
      ...
      (prev, [dir, alignments2]) => {
        ...
        for (let i = 0; i < arr.length - 1; i++) {
          for (let j = i + 1; j < arr.length; j++) {
            ...
            const alignment = (_a2 = groupAlignments[aGroupId]) == null ? void 0 : _a2[bGroupId];
...
//# sourceMappingURL=architectureDiagram-2XIMDMQ5-PDAO2REU.js.map
