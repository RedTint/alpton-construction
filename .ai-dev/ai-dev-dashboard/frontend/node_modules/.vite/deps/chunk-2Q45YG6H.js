...
// node_modules/mermaid/dist/chunks/mermaid.core/chunk-7R4GIKGN.mjs
...
var assignWithDepth = __name((dst, src, { depth = 2, clobber = false } = {}) => {
...
var getEffectiveHtmlLabels = __name((config2) => {
  var _a8, _b;
  if (((_a8 = config2.flowchart) == null ? void 0 : _a8.htmlLabels) != void 0) {
    issueWarning("FLOWCHART_HTML_LABELS_DEPRECATED");
  }
  return evaluate(config2.htmlLabels ?? ((_b = config2.flowchart) == null ? void 0 : _b.htmlLabels) ?? true);
...
var hasKatex = __name((text2) => {
  var _a8;
  return (((_a8 = text2.match(katexRegex)) == null ? void 0 : _a8.length) ?? 0) > 0;
}, "hasKatex");
...
var renderKatexUnsanitized = __name(async (text2, config2) => {
  ...
  if (true) {
    const { default: katex } = await import("./katex-JSWW3VJF.js");
...
var themes = {};
var getStyles = __name((type, userStyles, options) => {
  let diagramStyles = "";
...
*/
//# sourceMappingURL=chunk-2Q45YG6H.js.map
