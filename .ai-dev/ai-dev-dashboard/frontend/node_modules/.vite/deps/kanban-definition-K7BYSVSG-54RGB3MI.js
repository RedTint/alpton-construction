...
var addNode = __name((level, id, descr, type, shapeData) => {
  ...
  if (shapeData !== void 0) {
    ...
    if (doc == null ? void 0 : doc.label) {
      node.label = doc == null ? void 0 : doc.label;
    }
    if (doc == null ? void 0 : doc.icon) {
      node.icon = doc == null ? void 0 : doc.icon.toString();
    }
    if (doc == null ? void 0 : doc.assigned) {
      node.assigned = doc == null ? void 0 : doc.assigned.toString();
    }
    if (doc == null ? void 0 : doc.ticket) {
      node.ticket = doc == null ? void 0 : doc.ticket.toString();
    }
    if (doc == null ? void 0 : doc.priority) {
      node.priority = doc == null ? void 0 : doc.priority;
    }
  }
...
//# sourceMappingURL=kanban-definition-K7BYSVSG-54RGB3MI.js.map
