...
// node_modules/mermaid/dist/chunks/mermaid.core/c4Diagram-IC4MRINW.mjs
...
var c4Db_default = {
  ...
  getAccDescription,
  setAccDescription,
  getConfig: __name(() => getConfig2().c4, "getConfig"),
  clear,
  LINETYPE,
  ARROWTYPE,
  PLACEMENT,
...
var drawImage = __name(function(elem, width, height, x, y, link) {
...
var drawRels = __name((elem, rels2, conf2) => {
...
var drawC4Shape = __name(function(elem, c4Shape, conf2) {
  var _a3;
  ...
  textFontConf.fontColor = fontColor;
  if (c4Shape.techn && ((_a3 = c4Shape.techn) == null ? void 0 : _a3.text) !== "") {
    _drawTextCandidateFunc(conf2)(
      c4Shape.techn.text,
      c4ShapeElem,
      c4Shape.x,
...
var insertArrowEnd = __name(function(elem) {
...
var insertDynamicNumber = __name(function(elem) {
...
var getC4ShapeFont = __name((cnf, typeC4Shape) => {
  return {
...
var c4ShapeFont = __name((cnf, typeC4Shape) => {
  return {
    fontFamily: cnf[typeC4Shape + "FontFamily"],
    fontSize: cnf[typeC4Shape + "FontSize"],
    fontWeight: cnf[typeC4Shape + "FontWeight"]
...
var drawC4ShapeArray = __name(function(currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
  let Y = 0;
...
var drawRels2 = __name(function(diagram2, rels2, getC4ShapeObj, diagObj) {
  let i = 0;
  for (let rel of rels2) {
    i = i + 1;
...
var draw = __name(function(_text, id, _version, diagObj) {
  conf = getConfig2().c4;
...
//# sourceMappingURL=c4Diagram-IC4MRINW-4MQNXRKG.js.map
