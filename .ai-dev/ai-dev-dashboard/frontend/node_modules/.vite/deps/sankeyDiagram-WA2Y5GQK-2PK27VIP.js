...
// node_modules/mermaid/dist/chunks/mermaid.core/sankeyDiagram-WA2Y5GQK.mjs
var parser = (function() {
...
${prefix}${Math.round(value2 * 100) / 100}${suffix}`;
  ...
  switch (linkColor) {
    case "gradient":
      ...
      break;
    case "source":
      coloring = __name((d) => colorScheme(d.source.id), "coloring");
      break;
    case "target":
      coloring = __name((d) => colorScheme(d.target.id), "coloring");
      break;
    default:
      coloring = linkColor;
  }
...
//# sourceMappingURL=sankeyDiagram-WA2Y5GQK-2PK27VIP.js.map
