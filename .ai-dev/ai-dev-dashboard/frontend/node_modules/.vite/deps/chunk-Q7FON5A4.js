...
// node_modules/mermaid/dist/chunks/mermaid.core/chunk-PU5JKC2W.mjs
var unknownIcon = {
...
function nonMarkdownToLines(nonMarkdownText) {
  return nonMarkdownText.split(/\\n|\n|<br\s*\/?>/gi).map(
    (line) => {
      var _a2;
      return ((_a2 = line.trim().match(/<[^>]+>|[^\s<>]+/g)) == null ? void 0 : _a2.map((word) => ({ content: word, type: "normal" }))) ?? [];
    }
  );
}
...
//# sourceMappingURL=chunk-Q7FON5A4.js.map
