...
// node_modules/mermaid/dist/chunks/mermaid.core/flowDiagram-PKNHOUZH.mjs
...
var draw = __name(async function(text, id, _version, diag) {
  ...
  for (const vertex of data4Layout.nodes) {
    const node = select_default(`#${id} [id="${vertex.id}"]`);
    if (!node || !vertex.link) {
      continue;
    }
...
//# sourceMappingURL=flowDiagram-PKNHOUZH-VENZFNVI.js.map
