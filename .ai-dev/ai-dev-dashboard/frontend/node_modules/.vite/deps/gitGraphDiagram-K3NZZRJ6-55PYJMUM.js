import {
  populateCommonDb
} from "./chunk-SPUK5UMD.js";
import {
  parse
} from "./chunk-6IVW5UGN.js";
import {
  ImperativeState
} from "./chunk-CMZETHT4.js";
import "./chunk-ILIDJ73E.js";
import "./chunk-OXYNS6MT.js";
import "./chunk-UFXITZC2.js";
import "./chunk-7KCQDLQM.js";
import "./chunk-2RVLVYZK.js";
import "./chunk-QJSLMLIY.js";
import "./chunk-YCOLYE7V.js";
import "./chunk-6IPVNGFW.js";
import "./chunk-XBJJYQRV.js";
import "./chunk-HNM22KFX.js";
import {
  cleanAndMerge,
  random,
  utils_default
...
// node_modules/mermaid/dist/chunks/mermaid.core/gitGraphDiagram-K3NZZRJ6.mjs
var commitType = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
...
var findClosestParentPos = __name((commit2) => {
  var _a;
...
var calculateCommitPosition = __name((commit2) => {
  const closestParentPos = findClosestParentPos(commit2);
  return closestParentPos + COMMIT_STEP;
}, "calculateCommitPosition");
var setCommitPosition = __name((commit2, curPos) => {
...
var setRootPosition = __name((commit2, curPos, defaultPos2) => {
  const branch2 = branchPos.get(commit2.branch);
  if (!branch2) {
    throw new Error(`Branch not found for commit ${commit2.id}`);
  }
...
var drawCommitLabel = __name((gLabels, commit2, commitPosition, pos, gitGraphConfig) => {
  var _a;
...
var drawCommitTags = __name((gLabels, commit2, commitPosition, pos) => {
  var _a;
...
var calculatePosition = __name((commit2, dir2, pos, commitPos2) => {
...
var getCommitPosition = __name((commit2, pos, isParallelCommits) => {
  var _a, _b;
...
var findLane = __name((y1, y2, depth = 0) => {
...
var drawArrow = __name((svg, commitA, commitB, allCommits) => {
  var _a, _b, _c, _d, _e;
...
var drawBranches = __name((svg, branches, gitGraphConfig) => {
...
//# sourceMappingURL=gitGraphDiagram-K3NZZRJ6-55PYJMUM.js.map
