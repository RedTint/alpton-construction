...
// node_modules/mermaid/dist/chunks/mermaid.core/sequenceDiagram-2WXFIKYE.mjs
...
var getStyles = __name((options) => `.actor {
...
var drawActorTypeParticipant = __name(function(elem, actor, conf2, isFooter) {
  var _a2, _b;
...
var drawActorTypeCollections = __name(function(elem, actor, conf2, isFooter) {
  var _a2, _b;
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
...
var drawActorTypeQueue = __name(function(elem, actor, conf2, isFooter) {
  var _a2, _b;
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
...
var drawActorTypeControl = __name(function(elem, actor, conf2, isFooter) {
  var _a2;
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeEntity = __name(function(elem, actor, conf2, isFooter) {
  var _a2;
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 75;
...
var drawActorTypeDatabase = __name(function(elem, actor, conf2, isFooter) {
  var _a2;
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeBoundary = __name(function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeActor = __name(function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 80;
  const line = elem.append("g").lower();
...
var drawActor = __name(async function(elem, actor, conf2, isFooter) {
  switch (actor.type) {
    case "actor":
...
var drawActivation = __name(function(elem, bounds2, verticalPos, conf2, actorActivations2) {
  const rect = getNoteRect();
...
var drawLoop = __name(async function(elem, loopModel, labelText, conf2) {
  const {
    boxMargin,
    boxTextMargin,
    labelBoxHeight,
...
var insertDatabaseIcon = __name(function(elem) {
...
var insertArrowFilledHead = __name(function(elem) {
...
var insertSequenceNumber = __name(function(elem) {
  elem.append("defs").append("marker").attr("id", "sequencenumber").attr("refX", 15).attr("refY", 15).attr("markerWidth", 60).attr("markerHeight", 40).attr("orient", "auto").append("circle").attr("cx", 15).attr("cy", 15).attr("r", 6);
}, "insertSequenceNumber");
var insertArrowCrossHead = __name(function(elem) {
...
var insertSolidTopArrowHead = __name(function(elem) {
...
var insertSolidBottomArrowHead = __name(function(elem) {
...
var insertStickTopArrowHead = __name(function(elem) {
...
var insertStickBottomArrowHead = __name(function(elem) {
...
var drawNote = __name(async function(elem, noteModel) {
...
var drawMessage = __name(async function(diagram2, msgModel, lineStartY, diagObj, msg) {
...
var drawActors = __name(async function(diagram2, actors, actorKeys, isFooter) {
  if (!isFooter) {
    for (const actorKey of actorKeys) {
      const actor = actors.get(actorKey);
...
//# sourceMappingURL=sequenceDiagram-2WXFIKYE-YLU7XRSO.js.map
