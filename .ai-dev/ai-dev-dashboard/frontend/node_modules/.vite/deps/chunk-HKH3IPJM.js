import {
  getDiagramElement
} from "./chunk-4Z4MOHIT.js";
import {
  setupViewPortForSVG
} from "./chunk-P26OG7WX.js";
import {
  render
...
// node_modules/mermaid/dist/chunks/mermaid.core/chunk-NQ4KR5QH.mjs
var parser = (function() {
...
var getDir = __name((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var setupDoc = __name((parentParsedItem, doc, diagramStates, nodes, edges, altFlag, look, classes) => {
  log.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
...
var getDir2 = __name((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
    for (const parsedItemDoc of parsedItem.doc) {
      if (parsedItemDoc.stmt === "dir") {
...
var dataFetcher = __name((parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
  var _a2, _b, _c;
...
var newClassesList = __name(() => /* @__PURE__ */ new Map(), "newClassesList");
var newDoc = __name(() => ({
  relations: [],
  states: /* @__PURE__ */ new Map(),
  documents: {}
}), "newDoc");
var clone = __name((o) => JSON.parse(JSON.stringify(o)), "clone");
var _a;
...
//# sourceMappingURL=chunk-HKH3IPJM.js.map
