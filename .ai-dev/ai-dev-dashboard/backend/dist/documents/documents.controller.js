...
__decorate([
    (0, common_1.Get)(':path(*)'),
    (0, swagger_1.ApiOperation)({ summary: 'Get document by path' }),
    (0, swagger_1.ApiParam)({ name: 'path', description: 'Relative path to document from docs/' }),
    __param(0, (0, common_1.Param)('path')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DocumentsController.prototype, "getDocumentByPath", null);
