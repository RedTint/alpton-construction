...
story_id: 002-004
epic_id: '002'
story_name: Implement Admin Leads Dashboard
...
- [x] FE: Build data table view in the Admin portal
- [ ] BE: Fetch leads from Supabase with pagination/sorting
- [x] FE: Display all relevant lead fields including agent attribution
- [x] TEST: Verify leads dashboard loads and displays data correctly
