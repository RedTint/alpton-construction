...
story_id: 001-002
epic_id: '001'
story_name: Build Public Landing & Services Pages
story_status: done
priority: high
story_points: 5
assignees: []
...
updated_at: '2026-04-05T11:16:52.950Z'
completed_at: '2026-04-05T11:16:52.950Z'
uac_total: 4
uac_completed: 4
uac_pending: 0
...
- [x] FE: Implement static hero section with company profile
- [x] FE: Build services layout using standard UI components
- [x] FE: Ensure responsive design across mobile and desktop
- [x] TEST: Smoke test all public page routes render correctly
