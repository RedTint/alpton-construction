...
story_id: 001-005
epic_id: '001'
story_name: Capture Facebook Agent Attribution
story_status: done
priority: high
story_points: 3
assignees: []
...
- [x] FE: Parse `?agent=` URL parameter on initial page load
- [x] FE: Persist agent value in Zustand store and SessionStorage
- [x] FE: Include agent field in wizard submission payload
- [x] TEST: Verify agent value is captured and retained across page reloads
